...
with col2:
    ...
    # 🌟 여기에 사용자가 요청한 따뜻한 지지 문구 박스 추가!
    st.info("""
    🌱 **"기억하세요, 당신은 결코 혼자가 아닙니다."**
    
    학교폭력이나 가출, 혹은 혼자서는 도저히 해결하기 힘든 막막한 고립감이 찾아왔을 때, 모든 무게를 혼자서 버텨낼 필요는 없습니다. 
    우리 주위에는 손을 내밀어 줄 전문 복지시설과 국가의 지원 체계가 항상 든든하게 마련되어 있으며, 여러분은 이를 **충분히, 안전하게 누릴 권리**가 있습니다.
    
    도움을 요청하는 것은 부끄러운 일이 아닌, 나의 소중한 일상을 지키기 위한 가장 용기 있는 첫걸음입니다. 언제든 아래의 문을 두드려 주세요.
    """)
